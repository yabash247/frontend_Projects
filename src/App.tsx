...
import NetUseCreateForm from './components/Bsf/NetUseCreateForms';


import PondModal from './components/Bsf/PondModal';
    ...
    <Router>
      ...
      <Routes>
        ...
        <Route path="/" element={<PrivateRoute />}>
         ...
         <Route
            path="/batch/create-net-use" element={<NetUseCreateForm companyId={5} farmId={8} batchId={1} />}
          />
        </Route>
